...
<div class="main-content pre-posttest">
    ...
    <div class="row">
        <form action="<?= admin_url('gis/kemitraan/save-kemitraan') ?>" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="plazma" id="plazma" />
            <input type="hidden" name="farm_name" id="farm-name" />
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td data-label="PLAZMA">
                                        <input type="text" id="plazma-name" class="form-control" style="font-size: 14px;" readonly />
                                    </td> 
                                    <td data-label="AREA">
                                    ...
                                    <td data-label="UNIT">
                                        <input type="text" name="unit" id="unit-name" class="form-control" style="font-size: 14px;" />
                                    </td> 
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                <tr>
                                    <td data-label="LOCATION" style="padding-top: 20px !important">
                                        ...
                                        <input type="text" name="coordinate" class="form-control" placeholder="COODINATE"  style="font-size: 14px; width: 100%; margin-top: 15px !important" />
                                        <textarea id="address" name="address" class="form-control" rows="5" placeholder="ADDRESS" style="margin-top:10px; text-transform: uppercase;padding: 10px; font-size: 13px !important"></textarea>
                                    </td> 
                                    <td data-label="POPULASI">
                                        <input type="number" name="populasi" class="form-control" style="font-size: 13px !important;" placeholder="CTH : 54.000" />
                                    </td> 
                                </tr>
                            </tbody>
                        </table>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#farm").on('change', function() {
            let farm        = $("#farm option:selected");
            let farmName    = farm.data('farmname');
            let plazma      = farm.data('plazma');
            let plazmaName  = farm.data('plazmaname');
            let farmAddress = farm.data('farmaddress');

            $("#plazma").val(plazma);
            $("#farm-name").val(farmName);
            $("#plazma-name").val(plazmaName);
            $("#address").val(farmAddress);
        });
    });
