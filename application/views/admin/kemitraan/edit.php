...
<div class="main-content pre-posttest">
    <h3 class="card-title">
        <strong>GIS - KEMITRAAN</strong>
    </h3>
    <div class="row">
        <form action="<?= admin_url('gis/kemitraan/update') ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="content-task mt-5">
                    <div class="table-responsive">
                        <table class="table table-bordered" style="margin-bottom: 20px">
                            <thead>
                                <tr>
                                    <th style="text-align: left" width="25%">FARM</th>
                                    <th style="text-align: left" width="25%">PLAZMA</th>
                                    <th style="text-align: left" width="25%">AREA</th>
                            ...
                            <tbody>
                                <tr>
                                    <td data-label="FARM">
                                        <input type="text" value="<?= $kemitraan->FARM_NAME ?>" class="form-control" style="font-size: 14px;" readonly />
                                    </td> 
                                    <td data-label="PLAZMA">
                                        <input type="text" value="<?= $kemitraan->PLAZMA_NAME ?>" class="form-control" style="font-size: 14px;" readonly />
                                    </td> 
                                    <td data-label="AREA">
                                        <select id="area" class="form-control area-select" style="width: 100%;" name="area" required>
                                            <option value="" selected>- SELECT AREA -</option>
                                            <?php foreach ($area as $i => $v): ?>
                                                <option <?= $kemitraan->AREA == $i ? 'selected' : '' ?>  value="<?= $i ?>"><?= $i.' - '.$v ?></option>
                                            <?php endforeach ?>
                                        </select>
                                    </td>
                                    <td data-label="UNIT">
                                        <input type="text" value="<?= $kemitraan->UNIT ?>"  name="unit" id="unit-name" class="form-control" style="font-size: 14px;" />
                                    </td> 
                                </tr>
                            </tbody>
                        </table>
                        <table class="table table-bordered" style="margin-bottom: 20px">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: left" width="50%">POPULASI</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td data-label="LOCATION" style="padding-top: 20px !important">
                                        ...
                                        <input type="text" name="coordinate" class="form-control" placeholder="COODINATE"  style="font-size: 14px; width: 100%; margin-top: 15px !important" value="<?= $kemitraan->COORDINATE ?>" />
                                        <textarea id="address" name="address" class="form-control" rows="5" placeholder="ADDRESS" style="margin-top:10px; text-transform: uppercase;padding: 10px; font-size: 13px !important"><?= $kemitraan->ADDRESS ?></textarea>
                                    </td> 
                                    <td data-label="POPULASI">
                                        <input type="number" name="populasi" value="<?= $kemitraan->POPULASI ?>" class="form-control" style="font-size: 13px !important;" placeholder="CTH : 54.000" />
                                    </td> 
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                <tr>
                                    <td data-label="LINK GMAPS">
                                        <input type="text" name="link_gmaps" value="<?= $kemitraan->LINK_GMAPS ?>" class="form-control" style="font-size: 13px !important;" placeholder="HTTPS://GMAPS.COM" />
                                    </td> 
                                </tr>
                            </tbody>
                        </table>
            ...
            <div class="form-group row mt-5" style="margin: 20px 0px !important">
                <div class="col-lg-12 col-sm-12" style="display: flex; padding: 0px">
                    <a href="<?= admin_url('gis/kemitraan') ?>" class="btn btn-primary cust-btn-back" style="width: 50%; height: 50px; display: flex; align-items: center; justify-content: center;">CANCEL</a>
