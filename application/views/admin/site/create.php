...
<div class="main-content pre-posttest">
    ...
    <div class="row">
        <form action="<?= admin_url('gis/site/save-site') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <table class="table table-bordered" style="margin-bottom: 20px">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td data-label="NAME">
                                        <input type="text" name="name" class="form-control" style="font-size: 14px;" placeholder="CTH : FARM GPS JAKARTA" />
                                    </td> 
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                <tr>
                                    <td data-label="LOCATION" style="padding-top: 20px !important">
                                        ...
                                        <textarea name="address" class="form-control" rows="5" placeholder="ADDRESS" style="margin-top:10px; text-transform: uppercase;padding: 10px; font-size: 13px !important"></textarea>
                                    </td> 
                                    <td data-label="CAPACITY">
                                        <input type="number" name="capacity" class="form-control" style="font-size: 13px !important;" placeholder="CTH : 54.000" />
                                    </td> 
                                </tr>
                            </tbody>
                        </table>
