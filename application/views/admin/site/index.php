...
<div class="main-content pre-posttest">
	...
	<form class="form-horizontal" action="<?= admin_url('gis/site') ?>" method="POST" style="margin-bottom: 20px">
        <div class="row" style="padding: 0px 10px; border-bottom: 2px solid #000; padding-bottom: 8px;margin: 0px 0px;  ">
			...
			<div class="col-md-2 col-sm-12 filter-style"  style="display: flex;">
                ...
                <a href="<?= admin_url('gis/site/create-site') ?>" class="btn btn-primary btn-block" style="height: 36px; padding: 7px 10px 10px 10px; width: 100%; margin-top: 0px; background: green">CREATE</a>  
			</div>
        </div>
    </form>
			...
			<tbody>
				...
				<?php foreach ($gisite as $site): ?>
                    <tr>
                        ...
                        <td><?= $site['NAME'] ?></td>
                        <td><?= $site['REGION'] ?> - <?= $site['CITY'] ?></td>
                        <td><?= $site['CAPACITY'] ?></td>
                        <td>
                            <a href="<?= base_url('dashboard/gis/site/edit/' . $site['ID']) ?>" class="btn btn-sm btn-show-detail">EDIT</a>
							<a href="<?= base_url('dashboard/gis/site/delete/' . $site['ID']) ?>" class="btn btn-sm btn-show-cancel" onclick="return confirm('Yakin ingin menghapus data ini?')">DELETE</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
